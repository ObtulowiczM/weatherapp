    ...
    <main>
      ...
      <div class="weather-wrap" v-if="typeof weather.main != 'undefined'">
        ...
        <div class="weather-box">
          <div class="temperature">{{ Math.round(this.weather.main.temp) }}°C</div>
...
export default {
  ...
  data() {
    return {
      api_key: '15bf131f98566f533c529614e59b31b9',
...
.search-box .search-bar {
  ...
  background-color: rgb(179, 206, 247,0.5);
...
.search-box .search-bar:focus {
  ...
  background-color: rgb(179, 206, 247,0.75);
  border-radius: 16px 16px 16px 16px;
}
...
.weather-box .temperature {
  ...
  background-color: rgba(51, 97, 165, 0.35);
  border-radius: 16px;
  margin: 30px 0px;
